...
class RetinaAnchorGenerator(gluon.HybridBlock):
    ...
    def _generate_anchors(self, feature_size=None, anchor_size=None, anchor_size_ratios=None, anchor_aspect_ratios=None,
        ...
        norm_anchor_size_width = anchor_size / self._width
        norm_anchor_size_height = anchor_size / self._height
...
class RetinaNet(gluon.HybridBlock):
    ...
    def __init__(self, version=18,
        ...
        feature_sizes = []
        fpn_output = get_fpn_resnet(version, ctx=mx.cpu())(
        ...
        with self.name_scope():
            ...
            self._class_subnet = gluon.nn.HybridSequential()
            self._box_subnet = gluon.nn.HybridSequential()
