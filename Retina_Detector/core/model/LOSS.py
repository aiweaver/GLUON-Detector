...
class FocalLoss(gluon.HybridBlock):

    def __init__(self, alpha=0.25, gamma=2, sparse_label=True,
                 from_logits=False, batch_axis=0, num_class=None,
        ...
        self._num_class = num_class + 1  # plus background -주의
        self._eps = eps
    ...
    def hybrid_forward(self, F, pred, label, sample_weight=None):
        ...
        one_hot = one_hot[:, :, 1:]  # excluding background - 주의
