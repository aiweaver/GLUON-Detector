...
#     image_normalization = True : Retina 학습시, False : Visualization, Default True
#     box_normalization : True : Retina 학습시, False : Visualization, Default True
#     """
#     CLASSES = ['fire', 'smoke']
#
...
if __name__ == "__main__":
    ...
    dataset = DetectionDataset(path=os.path.join(root, 'Dataset', 'train'), input_size=(320, 640),
