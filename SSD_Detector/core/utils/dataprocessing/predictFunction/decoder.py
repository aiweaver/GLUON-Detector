...
class ClassDecoder(Block):
    ...
    def __init__(self, num_classes=None, thresh=0.01, softmax=False):
    ...
    def forward(self, cls_preds):
        ...
        scores = cls_preds.slice_axis(axis=-1, begin=1, end=None)  # batch x all feature number x foreground class
...
if __name__ == "__main__":
    ...
    classdecoder = ClassDecoder(num_classes=num_classes, thresh=0.01, softmax=False)
